...
import LevelTestReportView from '@/components/levelTest/LevelTestReportView';
      ...
      <MobileContentLoader loading={loading}>
        ...
        {report && (
          <div className="px-4 py-4 space-y-3">
            ...
            {/* 레벨 테스트 (객관 점수형 + 선생님 코멘트) */}
            {report.kind === 'LEVEL_TEST' && (
              <LevelTestReportView data={report.data as unknown as LevelTestReportData} />
            )}
